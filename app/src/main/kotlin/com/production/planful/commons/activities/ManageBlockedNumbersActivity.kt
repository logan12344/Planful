...
import com.production.planful.commons.adapters.ManageBlockedNumbersAdapter
import com.production.planful.commons.dialogs.AddBlockedNumberDialog
import com.production.planful.commons.dialogs.ExportBlockedNumbersDialog
import com.production.planful.commons.dialogs.FilePickerDialog
import com.production.planful.commons.extensions.*
import com.production.planful.commons.helpers.*
import com.production.planful.commons.helpers.BlockedNumbersExporter.ExportResult
...
class ManageBlockedNumbersActivity : BaseSimpleActivity(), RefreshRecyclerViewListener {
    ...
    private fun maybeSetDefaultCallerIdApp() {
        if (isQPlus() && baseConfig.appId.startsWith("com.production.planful.dialer")) {
