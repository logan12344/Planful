...
import com.production.planful.commons.extensions.getIntValue
import com.production.planful.commons.extensions.getStringValue
...
class MyContactsContentProvider {
    companion object {
        ...
        fun getSimpleContacts(context: Context, cursor: Cursor?): ArrayList<SimpleContact> {
            ...
            if (packageName != "com.production.planful.dialer" && packageName != "com.production.planful.smsmessenger" && packageName != "com.production.planful.calendar.pro") {
                return contacts
            }
