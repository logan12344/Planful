...
import com.production.planful.interfaces.EventTypesDao
import com.production.planful.interfaces.EventsDao
import com.production.planful.interfaces.TasksDao
import com.production.planful.interfaces.WidgetsDao
...
fun Context.addDayEvents(
    ...
    day.dayEvents.sortedWith(compareBy<Event> {
        ...
        (View.inflate(
            applicationContext,
            R.layout.day_monthly_event_view,
            null
...
fun Context.getDatesWeekDateTime(date: DateTime): String {
    return if (!config.startWeekWithCurrentDay) {
        ...
        var thisweek = date.withZone(DateTimeZone.UTC).withDayOfWeek(1).withHourOfDay(useHours)
